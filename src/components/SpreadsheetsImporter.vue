<template>
  <div class="spreadsheets">
    ...
    <pre id="show_token">{{ authResponse.access_token }}</pre>

    <pre id="show_token">{{ spreadsheetsResp }}</pre>
    ...
    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
        <input class="mdl-textfield__input" type="text" id="sid" size="100" v-model="spreadsheetsID">
